...
with open(SAVE_FILE1, 'rb') as f:
    ...
    # Loading possible asn_lookup data cached
    asn_lookup = {}
    # Uncomment the following lines if you have a cached ASN lookup data
    # if os.path.exists(SAVE_FILE2):
    #     asn_lookup = pickle.load(open(SAVE_FILE2, 'rb'))

    # Looking for AS numbers not yet looked up
    ...
    # Uncomment the following lines if you want to save the ASN lookup data
    # with open(SAVE_FILE2, 'wb') as f:
    #     pickle.dump(asn_lookup, f)
